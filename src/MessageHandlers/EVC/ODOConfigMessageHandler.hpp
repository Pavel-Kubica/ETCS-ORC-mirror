/** @file ODOConfigMessageHandler.hpp
 *
...
/**
 * Handles message 401: ODOConfig
 */
class ODOConfigMessageHandler : public MessageHandler {
public:
    explicit ODOConfigMessageHandler(ServiceContainer& container);
